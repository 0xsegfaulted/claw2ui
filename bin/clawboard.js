 ...
 *   clawboard publish --file page.html --title "Dashboard"
 *   clawboard publish --spec '{"components":[...]}' --title "Dashboard"
 *   clawboard publish --spec-file spec.json
 *   clawboard list
 *   clawboard delete <id>
 *   clawboard status
 *   clawboard start [--port 9800] [--no-tunnel]
 */
...
Examples:
  ...
  clawboard publish --file dashboard.html --title "Dashboard"
